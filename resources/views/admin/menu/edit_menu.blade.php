                ...
                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent_id" class="form-control">
                            ...
                            @foreach ($menus as $m)
                                <option value="{{ $m->id }}" <?php if ($m->id == $menu->parent_id) {
                                    echo 'selected';
                                } ?>>{{ $m->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="language">
                            @if (count($lang) > 0)
                                @foreach ($lang as $la)
                                    <option value="{{ $la->id }}" <?php if ($la->id == $menu->language) {
                                        echo 'selected';
                                    } ?>> {{ $la->name }} </option>
                                @endforeach
                            @endif
                    ...
                    <div class="form-group">
                        ...
                        <select name="menu_type" class="form-control">
                            ...
                            @foreach ($menu_type as $me)
                                <option value="{{ $me->id }}" <?php if ($menu->menu_type !== null) {
                                    if ($menu->menu_type->id == $me->id) {
                                        echo 'selected';
                                    }
                                } ?>>{{ $me->name }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="ordering" class="form-control">
                            ...
                            @foreach ($menus as $m)
                                <option value="{{ $m->id }}" <?php if ($m->id == $menu->id) {
                                    echo 'selected';
                                } ?>>{{ $m->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status">
                            <option value="1" <?php if ($menu->status == 1) {
                                echo 'selected';
                            } ?>>Active</option>
                            <option value="0" <?php if ($menu->status == 0) {
                                echo 'selected';
                            } ?>>Not Active</option>
                        </select>
                    </div>
